...
def average_blurring():
    ...
    # ksizex and ksizey will be the shape of the filter window (kernel)
    # Example: (ksizex=5, ksizey=5) is a 5x5 kernel
    ksizex = 0
    ksizey = 0
...
def img_sharpening_laplacian_1():
    cv2.namedWindow("img3", cv2.WINDOW_KEEPRATIO)
...
def img_sharpening_laplacian_2():
    img = cv2.imread("../../img/Lenna.png", cv2.IMREAD_GRAYSCALE)
